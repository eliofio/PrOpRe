...
<p align="justify"> Based on the selected option, you should refer to the appropriate section. If you choose the `density` option, please refer to <b><a href="#63---density-task">Section 6.3</a></b>. If you choose the `bin` option, please refer to <b><a href="#64---bin-task">Section 6.4</a></b>.
